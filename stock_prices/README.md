...
For example, ``python3 stock_prices.py`` should return 3530, which is the maximum profit that can be made from a single buy and then sell of these stock prices. 
